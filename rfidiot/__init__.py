...
if OptsEnv in os.environ:
    try:
        ...
        print("*** warning: config file set by ENV not found (%s) or empty!" %
              (os.environ[OptsEnv]))
    ...
    for o, a in opts:
        ...
        if o == '-N':
            ...
            card = RFIDIOt.rfidiot(
                readernum, readertype, line, speed, timeout, rfidiotglobals.Debug, noinit, nfcreader)
        ...
        if o == '-t':
            timeout = int(a)
    card = RFIDIOt.rfidiot(readernum, readertype, line, speed,
                           timeout, rfidiotglobals.Debug, noinit, nfcreader)
